          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <Link href="/app/education">
                <a className="flex  items-center justify-center px-2 py-2 font-medium tracking-wide text-inddigo-800  capitalize transition-colors duration-200 transform bg-indigo-100 rounded-md hover:bg-indigo-500 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-80">
                  <AiOutlineGoogle />
